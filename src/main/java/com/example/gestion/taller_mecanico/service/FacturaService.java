...
public interface FacturaService {
    ...
    Page<FacturaResponse> findFacturasByFilters(String search, Long mantenimientoId, Long clienteId, Long tallerId, LocalDateTime fechaEmisionDesde, LocalDateTime fechaEmisionHasta, BigDecimal minTotal, BigDecimal maxTotal, Pageable pageable);
    Page<FacturaResponse> findMyFacturasByFilters(String search, Long mantenimientoId, LocalDateTime fechaEmisionDesde, LocalDateTime fechaEmisionHasta, BigDecimal minTotal, BigDecimal maxTotal, Pageable pageable);
    Page<FacturaResponse> findFacturasByTallerId(Long tallerId, String search, Long mantenimientoId, Long clienteId, LocalDateTime fechaEmisionDesde, LocalDateTime fechaEmisionHasta, BigDecimal minTotal, BigDecimal maxTotal, Pageable pageable);
